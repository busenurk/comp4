...
###Günümüzde çoğu veri bilimi projesi, yapay öğrenme yaklaşımının doğru tahmin modelleri oluşturma hedefiyle daha fazla örütşmekte, veriyi açıklama maksatlı istatistik odağıyla daha az ilgilenmektedir.
